...
int luaReg_imgui_imguiImGuiSortDirection(lua_State* lua_S)
{
	...
	LUA_ENUM_ENTRY("None", ImGuiSortDirection::ImGuiSortDirection_None);
	LUA_ENUM_ENTRY("Ascending", ImGuiSortDirection::ImGuiSortDirection_Ascending);
	LUA_ENUM_ENTRY("Descending", ImGuiSortDirection::ImGuiSortDirection_Descending);
	LUA_ENUM_END();
	LUA_ENTRY_END(1);
	return 0;
}
...
#else
    LUA_GINVOKE_HEADER("ImGui", "ImGui.beginChildFrame");
    LUA_TRY_INVOKE_R(4, static_cast<bool (*)(ImGuiID, const ImVec2&, ImGuiChildFlags, ImGuiWindowFlags)>(&ImGui::BeginChild));
    LUA_TRY_INVOKE_R(3, [](ImGuiID arg0, const ImVec2& arg1, ImGuiWindowFlags arg2) {{ return ImGui::BeginChild(std::move(arg0), arg1, 0, arg2); }});
    LUA_TRY_INVOKE_R(2, [](ImGuiID arg0, const ImVec2& arg1) {{ return ImGui::BeginChild(std::move(arg0), arg1); }});
...
//	LUA_TRY_INVOKE_R(2, [](const ImGuiViewport* arg0,ImGuiDockNodeFlags arg1){{return ImGui::DockSpaceOverViewport(arg0, 0,std::move(arg1));}});
...
#else
    LUA_GINVOKE_HEADER("ImGui", "ImGui.endChildFrame");
    LUA_TRY_INVOKE(0, &ImGui::EndChild);
    LUA_GINVOKE_FOOTER("0");
#endif
}
